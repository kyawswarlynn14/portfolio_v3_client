...
import { setProjectInfo } from '@/store/layout/layoutSlice';
...
function ProjectInfo({ projectInfo }) {
  ...
  return (
    <form id='project-info' onSubmit={handleSubmit} className='w-full px-8 py-4 border border-cyan-300 rounded-xl shadow-xl'>
        <h3 className='text-center text-lg font-medium'>Project Info</h3>
